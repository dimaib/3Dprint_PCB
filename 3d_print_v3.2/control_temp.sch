...
F 1 "Красный" V 7675 4025 50  0000 R CNN
F 2 "LED_SMD:LED_0603_1608Metric_Castellated" H 7725 4100 50  0001 C CNN
...
F 1 "Красный" V 9700 4025 50  0000 R CNN
F 2 "LED_SMD:LED_0603_1608Metric_Castellated" H 9750 4100 50  0001 C CNN
...
F 0 "R39" H 2520 7046 50  0000 L CNN
F 1 "360" H 2520 6955 50  0000 L CNN
F 2 "Resistor_SMD:R_1206_3216Metric" V 2380 7000 50  0001 C CNN
F 3 "~" H 2450 7000 50  0001 C CNN
F 4 "https://www.chipdip.ru/product0/9000079904" H 2450 7000 50  0001 C CNN "Ссылка"
F 5 "2" H 2450 7000 50  0001 C CNN "Цена"
	1    2450 7000
	1    0    0    -1  
$EndComp
$Comp
...
F 1 "Красный" V 1050 7125 50  0000 R CNN
F 2 "LED_SMD:LED_0603_1608Metric_Castellated" H 1050 6700 50  0001 C CNN
...
extr0_hot
Text Label 7525 2250 2    50   ~ 0
extr0_hot
Text Label 9975 4750 0    50   ~ 0
extr1_hot
Text Label 7525 2350 2    50   ~ 0
extr1_hot
...
F 1 "Жёлтый" V 2625 3950 50  0000 R CNN
F 2 "LED_SMD:LED_0603_1608Metric_Castellated" H 2675 4025 50  0001 C CNN
...
F 1 "Жёлтый" V 4725 3950 50  0000 R CNN
F 2 "LED_SMD:LED_0603_1608Metric_Castellated" H 4775 4025 50  0001 C CNN
...
extr_fan_pow
Text Label 7525 2150 2    50   ~ 0
extr_fan_pow
Text HLabel 9850 2250 2    50   Input ~ 0
Auto_level
...
U 1 1 5EA026C9
P 2850 6650
F 0 "Q6" H 2625 6650 50  0000 L CNN
F 1 "BTA41-600" H 2875 6425 50  0000 L CNN
F 2 "3d_print:TOP3" H 3050 6575 50  0001 L CIN
F 3 "" H 2850 6650 50  0001 L CNN
F 4 "https://www.chipdip.ru/product/bta41-600brg" H 2850 6650 50  0001 C CNN "Ссылка"
F 5 "190" H 2850 6650 50  0001 C CNN "Цена"
F 6 "https://www.chipdip.ru/product/hs-202-20" H 2850 6650 50  0001 C CNN "Ссылка 2"
	1    2850 6650
	1    0    0    -1  
$EndComp
Wire Wire Line
...
F 0 "R48" H 5045 7046 50  0000 L CNN
F 1 "360" H 5045 6955 50  0000 L CNN
F 2 "Resistor_SMD:R_1206_3216Metric" V 4905 7000 50  0001 C CNN
F 3 "~" H 4975 7000 50  0001 C CNN
F 4 "https://www.chipdip.ru/product0/9000079904" H 4975 7000 50  0001 C CNN "Ссылка"
F 5 "2" H 4975 7000 50  0001 C CNN "Цена"
	1    4975 7000
	-1   0    0    -1  
$EndComp
$Comp
...
F 1 "Красный" V 6375 7125 50  0000 R CNN
F 2 "LED_SMD:LED_0603_1608Metric_Castellated" H 6375 6700 50  0001 C CNN
...
F 1 "BTA41-600" H 4600 6925 50  0000 L CNN
...
F 1 "4.7k" H 1775 1925 50  0000 L CNN
F 2 "Resistor_SMD:R_0603_1608Metric" V 1630 1975 50  0001 C CNN
F 3 "~" H 1700 1975 50  0001 C CNN
F 4 "https://www.chipdip.ru/product0/9000079728" H 1700 1975 50  0001 C CNN "Ссылка"
...
F 2 "Capacitor_Tantalum_SMD:CP_EIA-7343-31_Kemet-D" H 6250 3550 50  0001 C CNN
F 3 "~" H 6250 3550 50  0001 C CNN
F 4 "https://www.chipdip.ru/product0/168422814" H 6250 3550 50  0001 C CNN "Ссылка"
F 5 "42" H 6250 3550 50  0001 C CNN "Цена"
	1    6250 3550
	1    0    0    -1  
$EndComp
Wire Wire Line
...
F 1 "4.7k" H 6150 1925 50  0000 L CNN
F 2 "Resistor_SMD:R_0603_1608Metric" V 6005 1975 50  0001 C CNN
F 3 "~" H 6075 1975 50  0001 C CNN
F 4 "https://www.chipdip.ru/product0/9000079728" H 6075 1975 50  0001 C CNN "Ссылка"
...
F 1 "4.7k" H 5150 1925 50  0000 L CNN
F 2 "Resistor_SMD:R_0603_1608Metric" V 5005 1975 50  0001 C CNN
F 3 "~" H 5075 1975 50  0001 C CNN
F 4 "https://www.chipdip.ru/product0/9000079728" H 5075 1975 50  0001 C CNN "Ссылка"
...
F 1 "4.7k" H 4025 1925 50  0000 L CNN
F 2 "Resistor_SMD:R_0603_1608Metric" V 3880 1975 50  0001 C CNN
F 3 "~" H 3950 1975 50  0001 C CNN
F 4 "https://www.chipdip.ru/product0/9000079728" H 3950 1975 50  0001 C CNN "Ссылка"
...
F 1 "4.7k" H 2900 1925 50  0000 L CNN
F 2 "Resistor_SMD:R_0603_1608Metric" V 2755 1975 50  0001 C CNN
F 3 "~" H 2825 1975 50  0001 C CNN
F 4 "https://www.chipdip.ru/product0/9000079728" H 2825 1975 50  0001 C CNN "Ссылка"
...
U 1 1 6032C292
P 7725 3775
AR Path="/5E7630DD/6032C292" Ref="#PWR?"  Part="1" 
AR Path="/5E8DCDD3/6032C292" Ref="#PWR0169"  Part="1" 
F 0 "#PWR0169" H 7725 3625 50  0001 C CNN
F 1 "+12V" H 7740 3948 50  0000 C CNN
...
U 1 1 603399D4
P 6250 3350
AR Path="/5E7630DD/603399D4" Ref="#PWR?"  Part="1" 
AR Path="/5E8DCDD3/603399D4" Ref="#PWR0170"  Part="1" 
F 0 "#PWR0170" H 6250 3200 50  0001 C CNN
F 1 "+12V" H 6265 3523 50  0000 C CNN
...
U 1 1 6034513F
P 4775 3700
AR Path="/5E7630DD/6034513F" Ref="#PWR?"  Part="1" 
AR Path="/5E8DCDD3/6034513F" Ref="#PWR0171"  Part="1" 
F 0 "#PWR0171" H 4775 3550 50  0001 C CNN
F 1 "+12V" H 4790 3873 50  0000 C CNN
...
U 1 1 6035081F
P 2675 3700
AR Path="/5E7630DD/6035081F" Ref="#PWR?"  Part="1" 
AR Path="/5E8DCDD3/6035081F" Ref="#PWR0172"  Part="1" 
F 0 "#PWR0172" H 2675 3550 50  0001 C CNN
F 1 "+12V" H 2690 3873 50  0000 C CNN
...
U 1 1 6035BF0E
P 7525 2000
AR Path="/5E7630DD/6035BF0E" Ref="#PWR?"  Part="1" 
AR Path="/5E8DCDD3/6035BF0E" Ref="#PWR0173"  Part="1" 
F 0 "#PWR0173" H 7525 1850 50  0001 C CNN
F 1 "+12V" H 7540 2173 50  0000 C CNN
...
U 1 1 6036759C
P 9750 3775
AR Path="/5E7630DD/6036759C" Ref="#PWR?"  Part="1" 
AR Path="/5E8DCDD3/6036759C" Ref="#PWR0174"  Part="1" 
F 0 "#PWR0174" H 9750 3625 50  0001 C CNN
F 1 "+12V" H 9765 3948 50  0000 C CNN
...
$EndComp
$Comp
L 3d_print_main-rescue:Conn_01x04-Connector_Generic J24
U 1 1 60425B74
P 7775 2150
F 0 "J24" H 7855 2142 50  0000 L CNN
F 1 "Разъём нагрева" H 7855 2051 50  0000 L CNN
F 2 "Connector_Phoenix_MC:PhoenixContact_MCV_1,5_4-G-3.81_1x04_P3.81mm_Vertical" H 7775 2150 50  0001 C CNN
F 3 "" H 7775 2150 50  0001 C CNN
F 4 "https://www.chipdip.ru/product/ech381v-04p" H 7775 2150 50  0001 C CNN "Ссылка"
F 5 "https://www.chipdip.ru/product/15edgk-3.81-04" H 7775 2150 50  0001 C CNN "Ссылка 2"
	1    7775 2150
	1    0    0    -1  
$EndComp
Wire Wire Line
...
F 0 "#PWR0156" H 9175 2250 50  0001 C CNN
F 1 "GND" H 9180 2327 50  0000 C CNN
...
U 1 1 60344C3F
P 9450 2250
F 0 "J43" H 9500 2667 50  0000 C CNN
F 1 "Разъём экструдера" H 9500 2576 50  0000 C CNN
F 2 "Connector_IDC:IDC-Header_2x05_P2.54mm_Vertical" H 9450 2250 50  0001 C CNN
F 3 "~" H 9450 2250 50  0001 C CNN
F 4 "https://www.chipdip.ru/product/idc-10ms" H 9450 2250 50  0001 C CNN "Ссылка"
F 5 "https://www.chipdip.ru/product/idc-10f" H 9450 2250 50  0001 C CNN "Ссылка 2"
	1    9450 2250
	1    0    0    -1  
$EndComp
Text HLabel 9175 2150 0    50   Input ~ 0
PWM_BL_touch
Wire Wire Line
	9175 2500 9175 2450
Wire Wire Line
...
U 1 1 603EA67E
P 9050 2000
AR Path="/5E724F7F/603EA67E" Ref="#PWR?"  Part="1" 
AR Path="/603EA67E" Ref="#PWR?"  Part="1" 
AR Path="/5E8DCDD3/603EA67E" Ref="#PWR0152"  Part="1" 
F 0 "#PWR0152" H 9050 1850 50  0001 C CNN
F 1 "+5VD" H 8900 2075 50  0000 C CNN
...
U 1 1 603637B1
P 8750 3550
AR Path="/5E8DCDD3/603637B1" Ref="J49"  Part="1" 
AR Path="/5EB034C6/603637B1" Ref="J?"  Part="1" 
F 0 "J49" H 8750 3675 50  0000 C CNN
F 1 "Охлаждение платы" H 8850 3300 50  0000 C CNN
F 2 "3d_print:PhoenixContact_MCV_1,5_2-G-3.5_1x02_P3.50mm_Vertical" H 8750 3550 50  0001 C CNN
F 3 "~" H 8750 3550 50  0001 C CNN
F 4 "https://www.chipdip.ru/product/kls2-edv-3.50-02p-4-15edgvc-3.5-02p" H 8750 3550 50  0001 C CNN "Ссылка"
F 5 "11" H 8750 3550 50  0001 C CNN "Цена"
	1    8750 3550
	1    0    0    -1  
$EndComp
$Comp
...
U 1 1 603637B7
P 8400 3800
AR Path="/603637B7" Ref="#PWR?"  Part="1" 
AR Path="/5E8DCDD3/603637B7" Ref="#PWR014"  Part="1" 
...
U 1 1 603637BF
P 8400 3600
AR Path="/5E724F7F/603637BF" Ref="C?"  Part="1" 
AR Path="/5E8DCDD3/603637BF" Ref="C9"  Part="1" 
F 0 "C9" H 8200 3600 50  0000 L CNN
F 1 "10uF" H 8200 3525 50  0000 L CNN
F 2 "Capacitor_Tantalum_SMD:CP_EIA-7343-31_Kemet-D" H 8400 3600 50  0001 C CNN
F 3 "~" H 8400 3600 50  0001 C CNN
F 4 "https://www.chipdip.ru/product0/168422814" H 8400 3600 50  0001 C CNN "Ссылка"
F 5 "42" H 8400 3600 50  0001 C CNN "Цена"
	1    8400 3600
	1    0    0    -1  
$EndComp
Wire Wire Line
...
U 1 1 603637D1
P 8400 3400
AR Path="/5E7630DD/603637D1" Ref="#PWR?"  Part="1" 
AR Path="/5E8DCDD3/603637D1" Ref="#PWR06"  Part="1" 
